    ...
    <section className="md:w-512 mx-auto relative">
      <div className="bg-ground p-16 xs:p-24 sm:p-48 -mx-12 md:mx-auto text-center border-4 border-primary relative z-1">
        ...
        <p>
          <Link
            href={`tel:${PHONE}`}
            className="font-funky font-bold text-4xl xs:text-5xl sm:text-7xl hover:text-accent transition">
        ...
        <p className="my-24 sm:my-8">
          <Link
            href={`mailto:${EMAIL}`}
            className="xs:text-xl sm:text-2xl underline break-words hover:text-accent transition">
